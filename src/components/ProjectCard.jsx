...
const ProjectCard = ({
  ...
  return (
    <div className="relative bg-white shadow-md rounded-lg overflow-hidden h-48 sm:h-60 lg:h-80">
      {" "}
      {/* Ajustez la hauteur ici si nécessaire */}
      ...
      <div className="relative p-4 rounded-lg h-full flex flex-col justify-between">
        ...
        <div className="flex justify-between text-sm lg:text-xl">
          <a
            ...
            className="bg-main1 text-black px-4 py-2 rounded-md hover:bg-bg1 hover:text-main1 shadow-3d z-50"
          >
            GitHub
          </a>
          <a
