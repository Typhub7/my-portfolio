...
const HowAmIPage = () => {
  ...
  const title = language === 'fr' ? 'Developpeuse Front-End' : 'Front-End Developer';
  const subtitle = language === 'fr' ? '& Testeuse QA' : '& QA Tester';

  return (
    <section id="howamI" className="pt-2 lg:pt-6 bg-bg3">
      <div className="flex flex-col">
        <h2 className="text-main1 text-center font-sans text-2xl md:text-4xl lg:text-6xl mt-4 mb-2 lg:mt-6 lg:mb-6">{title}</h2>
        <h2 className="text-main1 text-center font-sans text-xl md:text-3xl lg:text-5xl mt-4 mb-2 lg:mt-3 lg:mb-4">{subtitle}</h2>
        <LineWithDots />
