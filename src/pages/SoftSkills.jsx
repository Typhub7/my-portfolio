  ...
  return (
    <section className="bg-code-bg">
      ...
      <div className="flex flex-col justify-center items-center py-8">
        <div
          id="softskills"
          className="border-2 border-bg2 rounded-3xl px-6 bg-gradient-to-b from-bg4 to-bg5"
        >
          <h2 className="text-main1 font-sans text-2xl md:text-4xl lg:text-6xl my-4 text-shadow-custom">
            SoftSkills
          </h2>
        </div>
        <LineWithDots />
      ...
      <button
        ...
        className="flex justify-center mt-0 lg:mt-8 pb-6 lg:pb-8 w-full"
      >
